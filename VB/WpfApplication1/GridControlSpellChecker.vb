...
'#Region "#SubscribeToEvents"
        Private Sub SubscribeToEvents()
            ...
            If cardView IsNot Nothing Then AddHandler cardView.ShownEditor, AddressOf CardView_ShownEditor
        End Sub
        ...
        Private Sub UnsubscribeFromEvents()
            ...
            Dim cardView As CardView = TryCast(Grid.View, CardView)
            If cardView IsNot Nothing Then RemoveHandler cardView.ShownEditor, AddressOf CardView_ShownEditor
        End Sub
...
'#Region "#ShownEditor"
        Private Sub CardView_ShownEditor(ByVal sender As Object, ByVal e As EditorEventArgs)
            ...
            If SpellChecker.SpellCheckMode = DevExpress.XtraSpellChecker.SpellCheckMode.OnDemand Then CheckActiveEditor(activeEditor)
        End Sub

        Private Sub CheckActiveEditor(ByVal activeEditor As BaseEdit)
            activeEditor.Dispatcher.BeginInvoke(New Action(Sub()
                If SpellChecker.CanCheck(activeEditor) Then SpellChecker.Check(activeEditor)
